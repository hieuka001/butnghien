...
export default defineConfig(({ mode }) => {
    ...
    return {
      ...
      define: {
        ...
        'process.env.GEMINI_WRITER_API_KEY': JSON.stringify(exposeClientGeminiKeys ? env.GEMINI_WRITER_API_KEY : ''),
        'process.env.GEMINI_WRITER_API_KEY_2': JSON.stringify(exposeClientGeminiKeys ? env.GEMINI_WRITER_API_KEY_2 : ''),
        'process.env.GEMINI_REVIEWER_API_KEY': JSON.stringify(exposeClientGeminiKeys ? env.GEMINI_REVIEWER_API_KEY : ''),
        'process.env.GEMINI_REVIEWER_API_KEY_2': JSON.stringify(exposeClientGeminiKeys ? env.GEMINI_REVIEWER_API_KEY_2 : ''),
        'process.env.GEMINI_REWRITER_API_KEY': JSON.stringify(exposeClientGeminiKeys ? env.GEMINI_REWRITER_API_KEY : ''),
        'process.env.GEMINI_REWRITER_API_KEY_2': JSON.stringify(exposeClientGeminiKeys ? env.GEMINI_REWRITER_API_KEY_2 : ''),
